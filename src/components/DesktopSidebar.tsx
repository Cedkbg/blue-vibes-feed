import { Home, Video, Users, Phone, MessageCircle, User, Search, PlusCircle, Radio, Settings, Compass, Flame } from "lucide-react";
...
const navItems: NavItem[] = [
  ...
  { icon: Flame, label: "Tendances", path: "/trending" },
