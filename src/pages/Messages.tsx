...
import { Search, Plus, Users, MessageCircle, Camera } from "lucide-react";
...
const Messages = () => {
  ...
  useEffect(() => { fetchConversations(); fetchUsers(); }, [user]);
      ...
      <header className="bg-primary text-primary-foreground px-6 py-4">
        ...
        <div className="relative">
          ...
          <Input
            ...
            className="pl-10 bg-primary-foreground/10 border-none text-primary-foreground placeholder:text-primary-foreground/50 focus-visible:ring-primary-foreground/30"
          />
        </div>
      </header>
              ...
              <div className="flex-1 text-left min-w-0">
                <div className="flex items-center justify-between mb-0.5">
                  ...
                  <span className={`text-xs flex-shrink-0 ml-2 ${
                    conversation.unread_count && conversation.unread_count > 0 ? "text-primary font-semibold" : "text-muted-foreground"
                  }`}>
